...
// MARK: - tirar tela vazia do final
...
//                    Spacer()
                    ...
                    VStack(spacing: 16) {
                                Text("Heads Up!")
                                    .font(.custom("TorukSC-Regular", size: 72, relativeTo: .largeTitle))
                                    .multilineTextAlignment(.center)
                 
                                    .foregroundColor(.white)

                                Text("Things make way more sense after the tutorial...")
                                    .font(.custom("TorukSC-Regular", size: 40, relativeTo: .title))
                                    .multilineTextAlignment(.center)
                                    .foregroundColor(.white)
                            }
...
#Preview {
    TutorialHubView(router: .constant(.play))
}
